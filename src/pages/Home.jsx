  ...
  return (
    <div className="h-screen w-full relative overflow-hidden">
      ...
      >
        ...
        >
          <div className="h-[30vh] lg:h-full lg:w-1/2 relative overflow-hidden">
          ...
          <div className="h-[70vh] lg:h-full lg:w-1/2 flex flex-col justify-center items-start px-8 sm:px-16 lg:px-20 pb-8 lg:pb-0 relative bg-zinc-950">
        ...
        <section 
          ref={sectionRefs[3]} 
          className="h-screen w-full snap-start relative flex flex-col justify-center md:justify-end p-8 sm:p-16 lg:p-24 bg-zinc-950 pb-20 md:pb-24"
        >
